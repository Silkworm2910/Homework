...
public class Lesson21 {
    public static void main(String[] args) throws InterruptedException {
        ...
        Sync sync = new Sync();
        List<Sync.Adder> adderList = new ArrayList<>(1000);
...
class Sync {
    ...
    class Storage {
        ...
        public synchronized void getBook() throws InterruptedException {
            System.out.println("gerBook START");
            while (booksCount < 1) {
                    wait();;
            }

            booksCount --;
            System.out.println("Одну книгу забрали из бибилотеки");
            System.out.println("Книг в библиотеке: " + booksCount);
            notify(); // notifyAll()
            System.out.println("gerBook FINISH");
